...
public class MainLayout extends AppLayout {
    ...
    private SideNav createNavigation() {
        ...
        if (accessChecker.hasAccess(FinancesView.class)) {
            nav.addItem(
                    new SideNavItem("Finances", FinancesView.class, LineAwesomeIcon.MONEY_BILL_WAVE_SOLID.create()));

        }
        if (accessChecker.hasAccess(DataConfigurationView.class)) {
            nav.addItem(new SideNavItem("Data Configuration", DataConfigurationView.class,
                    LineAwesomeIcon.WRENCH_SOLID.create()));
